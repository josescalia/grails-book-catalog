			...
			<table>
				...
				<g:each in="${bookInstanceList}" status="i" var="bookInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${bookInstance.id}">${fieldValue(bean: bookInstance, field: "author.authorName")}</g:link></td>
					
						<td>${fieldValue(bean: bookInstance, field: "bookTitle")}</td>
